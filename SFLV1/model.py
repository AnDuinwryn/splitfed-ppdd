...
#-----------------------------------------------------------------------------------------------------------------------------#
class cli_cnn_net(nn.Module):
    def __init__(self, n_channel: int):
        super().__init__()
        self.conv1 = nn.Conv2d(in_channels=n_channel, out_channels=32, kernel_size=(3, 3), padding=1)
...
class serv_cnn_net(nn.Module):
    def __init__(self, n_freq: int):
        ...
        self.fc1 = nn.Linear(n_freq * 16, 128)
